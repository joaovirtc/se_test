...
const Loading = () => {
    return (
        <div className="w-screen h-screen bg-white flex flex-col items-center justify-center gap-y-4">
            <Image src={Logo} alt="logo-softexpert" width={204} className='' />
            <svg className="text-black animate-spin" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
