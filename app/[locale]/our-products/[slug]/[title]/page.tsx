...
import SlideArtifacts from "@/app/components/ui/slide/artifacts/slider-artifacts-products";
...
export default async function Page(props: { params: Promise<Props> }) {
  ...
  let industry: Solution | undefined;
  ...
  return (
    <>
      <UpdateLocalizationsData data={result} path={"/our-products/[slug]"} catSlug={true} />
